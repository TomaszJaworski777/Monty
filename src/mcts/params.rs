...
make_mcts_params! {
    ...
    end_cpuct: f32 = 0.386, 0.1, 5.0, 0.026, 0.002;
    start_depth_decay: f32 = 260.175, 0.1, 500.0, 35.0, 0.002;
    end_depth_decay: f32 = 84.148, 0.1, 500.0, 35.0, 0.002;
    depth_decay_factor: f32 = 115.374, 0.1, 500.0, 10.0, 0.002;
