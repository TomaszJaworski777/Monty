...
make_mcts_params! {
    ...
    knight_value: i32 = 397, 250, 750, 25, 0.002;
    bishop_value: i32 = 401, 250, 750, 25, 0.002;
    rook_value: i32 = 758, 400, 1000, 30, 0.002;
    queen_value: i32 = 1505, 900, 1600, 35, 0.002;
    scale_start_pos: f32  =  0.6859,     0.5,    1.5,     0.05,  0.002;
    scale_zero_mat: f32  =  0.6051,     0.1,    1.0,     0.05,  0.002;
    material_power: f32  =  0.9812,     0.1,    5.0,     0.1,   0.002;
    wl_dampening_power: f32  =  20.1599,    1.0,    50.0,    2.0,   0.002;
